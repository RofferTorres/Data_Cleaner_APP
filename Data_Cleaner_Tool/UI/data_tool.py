...
"")
        ...
        self.lineLeftMenu = QFrame(self.leftMenuContainer)
        self.lineLeftMenu.setObjectName(u"lineLeftMenu")
        self.lineLeftMenu.setStyleSheet(u"color: rgb(48, 53, 61);")
        self.lineLeftMenu.setFrameShadow(QFrame.Raised)
        self.lineLeftMenu.setLineWidth(2)
        self.lineLeftMenu.setMidLineWidth(0)
        self.lineLeftMenu.setFrameShape(QFrame.VLine)

        self.horizontalLayout_4.addWidget(self.lineLeftMenu)
