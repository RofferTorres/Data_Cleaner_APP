...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_3.setContentsMargins(12, 35, -1, 35)
        ...
        self.csvBasicGroup = QGroupBox(self.basicSettingsFrame)
        self.csvBasicGroup.setObjectName(u"csvBasicGroup")
        sizePolicy5 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy5.setHorizontalStretch(5)
        sizePolicy5.setVerticalStretch(0)
        sizePolicy5.setHeightForWidth(self.csvBasicGroup.sizePolicy().hasHeightForWidth())
        self.csvBasicGroup.setSizePolicy(sizePolicy5)
        self.csvBasicGroup.setMinimumSize(QSize(0, 0))
        font8 = QFont()
        font8.setFamilies([u"Calibri"])
        font8.setPointSize(12)
        self.csvBasicGroup.setFont(font8)
        self.verticalLayout_5 = QVBoxLayout(self.csvBasicGroup)
        self.verticalLayout_5.setSpacing(10)
        self.verticalLayout_5.setObjectName(u"verticalLayout_5")
        self.verticalLayout_5.setContentsMargins(-1, -1, -1, 12)
        self.delimiterLabel = QLabel(self.csvBasicGroup)
        self.delimiterLabel.setObjectName(u"delimiterLabel")
        font9 = QFont()
        font9.setFamilies([u"Calibri"])
        font9.setPointSize(13)
        font9.setBold(True)
        self.delimiterLabel.setFont(font9)

        self.verticalLayout_5.addWidget(self.delimiterLabel)

        self.commaRadioBtn = QRadioButton(self.csvBasicGroup)
        self.commaRadioBtn.setObjectName(u"commaRadioBtn")
        font10 = QFont()
        font10.setFamilies([u"Calibri"])
        font10.setPointSize(13)
        self.commaRadioBtn.setFont(font10)
        self.commaRadioBtn.setFocusPolicy(Qt.ClickFocus)
        self.commaRadioBtn.setAutoFillBackground(False)
        self.commaRadioBtn.setStyleSheet(u"background-color: rgba(255, 255, 255, 0);")
        self.commaRadioBtn.setChecked(True)

        self.verticalLayout_5.addWidget(self.commaRadioBtn)

        self.semiclonRadioBtn = QRadioButton(self.csvBasicGroup)
        self.semiclonRadioBtn.setObjectName(u"semiclonRadioBtn")
        self.semiclonRadioBtn.setFont(font10)
        self.semiclonRadioBtn.setFocusPolicy(Qt.ClickFocus)
        self.semiclonRadioBtn.setAutoFillBackground(False)

        self.verticalLayout_5.addWidget(self.semiclonRadioBtn)

        self.pipelineRadioBtn = QRadioButton(self.csvBasicGroup)
        self.pipelineRadioBtn.setObjectName(u"pipelineRadioBtn")
        self.pipelineRadioBtn.setFont(font10)
        self.pipelineRadioBtn.setFocusPolicy(Qt.ClickFocus)
        self.pipelineRadioBtn.setAutoFillBackground(False)

        self.verticalLayout_5.addWidget(self.pipelineRadioBtn)

        self.tebRadioBtn = QRadioButton(self.csvBasicGroup)
        self.tebRadioBtn.setObjectName(u"tebRadioBtn")
        self.tebRadioBtn.setFont(font10)
        self.tebRadioBtn.setFocusPolicy(Qt.ClickFocus)
        self.tebRadioBtn.setAutoFillBackground(False)

        self.verticalLayout_5.addWidget(self.tebRadioBtn)


        self.gridLayout.addWidget(self.csvBasicGroup, 1, 0, 2, 1)

        self.generalBasicGroup = QGroupBox(self.basicSettingsFrame)
        self.generalBasicGroup.setObjectName(u"generalBasicGroup")
        sizePolicy6 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)
        sizePolicy6.setHorizontalStretch(5)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.generalBasicGroup.sizePolicy().hasHeightForWidth())
        self.generalBasicGroup.setSizePolicy(sizePolicy6)
        self.generalBasicGroup.setFont(font8)
        self.generalBasicGroup.setFlat(False)
        self.generalBasicGroup.setCheckable(False)
        self.gridLayout_2 = QGridLayout(self.generalBasicGroup)
        self.gridLayout_2.setSpacing(10)
        self.gridLayout_2.setObjectName(u"gridLayout_2")
        self.outFilenameLabel = QLabel(self.generalBasicGroup)
        self.outFilenameLabel.setObjectName(u"outFilenameLabel")
        sizePolicy5.setHeightForWidth(self.outFilenameLabel.sizePolicy().hasHeightForWidth())
        self.outFilenameLabel.setSizePolicy(sizePolicy5)
        self.outFilenameLabel.setFont(font9)

        self.gridLayout_2.addWidget(self.outFilenameLabel, 2, 0, 1, 1, Qt.AlignLeft)

        self.outFilenameEntry = QLineEdit(self.generalBasicGroup)
        self.outFilenameEntry.setObjectName(u"outFilenameEntry")
        sizePolicy7 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy7.setHorizontalStretch(5)
        sizePolicy7.setVerticalStretch(0)
        sizePolicy7.setHeightForWidth(self.outFilenameEntry.sizePolicy().hasHeightForWidth())
        self.outFilenameEntry.setSizePolicy(sizePolicy7)
        self.outFilenameEntry.setMaximumSize(QSize(300, 16777215))
        font11 = QFont()
        font11.setFamilies([u"Calibri"])
        font11.setPointSize(12)
        font11.setItalic(True)
        self.outFilenameEntry.setFont(font11)
        self.outFilenameEntry.setMouseTracking(False)
        self.outFilenameEntry.setFocusPolicy(Qt.ClickFocus)
        self.outFilenameEntry.setReadOnly(False)
        self.outFilenameEntry.setCursorMoveStyle(Qt.VisualMoveStyle)
        self.outFilenameEntry.setClearButtonEnabled(True)

        self.gridLayout_2.addWidget(self.outFilenameEntry, 2, 1, 1, 1)

        self.skipEmptyRowRadioBtn = QCheckBox(self.generalBasicGroup)
        self.skipEmptyRowRadioBtn.setObjectName(u"skipEmptyRowRadioBtn")
        sizePolicy8 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
        sizePolicy8.setHorizontalStretch(5)
        sizePolicy8.setVerticalStretch(0)
        sizePolicy8.setHeightForWidth(self.skipEmptyRowRadioBtn.sizePolicy().hasHeightForWidth())
        self.skipEmptyRowRadioBtn.setSizePolicy(sizePolicy8)
        self.skipEmptyRowRadioBtn.setFont(font9)
        self.skipEmptyRowRadioBtn.setFocusPolicy(Qt.ClickFocus)
        self.skipEmptyRowRadioBtn.setChecked(True)

        self.gridLayout_2.addWidget(self.skipEmptyRowRadioBtn, 5, 0, 1, 1)

        self.trimAllColumnsRadioBtn = QCheckBox(self.generalBasicGroup)
        self.trimAllColumnsRadioBtn.setObjectName(u"trimAllColumnsRadioBtn")
        sizePolicy8.setHeightForWidth(self.trimAllColumnsRadioBtn.sizePolicy().hasHeightForWidth())
        self.trimAllColumnsRadioBtn.setSizePolicy(sizePolicy8)
        self.trimAllColumnsRadioBtn.setFont(font9)
        self.trimAllColumnsRadioBtn.setFocusPolicy(Qt.ClickFocus)
        self.trimAllColumnsRadioBtn.setChecked(True)

        self.gridLayout_2.addWidget(self.trimAllColumnsRadioBtn, 5, 1, 1, 1, Qt.AlignLeft)


        self.gridLayout.addWidget(self.generalBasicGroup, 1, 1, 1, 1)

        self.basicSettingsBtn = QPushButton(self.basicSettingsFrame)
        self.basicSettingsBtn.setObjectName(u"basicSettingsBtn")
        self.basicSettingsBtn.setFont(font10)
        icon10 = QIcon()
        ...
        self.basicSettingsBtn.setIcon(icon10)
        self.basicSettingsBtn.setCheckable(True)

        self.gridLayout.addWidget(self.basicSettingsBtn, 0, 0, 1, 1, Qt.AlignLeft)

        self.excelBasicGroup = QGroupBox(self.basicSettingsFrame)
        self.excelBasicGroup.setObjectName(u"excelBasicGroup")
        sizePolicy5.setHeightForWidth(self.excelBasicGroup.sizePolicy().hasHeightForWidth())
        self.excelBasicGroup.setSizePolicy(sizePolicy5)
        self.excelBasicGroup.setFont(font8)
        self.excelBasicGroup.setCheckable(False)
        self.horizontalLayout_7 = QHBoxLayout(self.excelBasicGroup)
        self.horizontalLayout_7.setSpacing(25)
        self.horizontalLayout_7.setObjectName(u"horizontalLayout_7")
        self.sheetnameLabel = QLabel(self.excelBasicGroup)
        self.sheetnameLabel.setObjectName(u"sheetnameLabel")
        self.sheetnameLabel.setFont(font9)

        self.horizontalLayout_7.addWidget(self.sheetnameLabel)

        self.sheetEntry = QLineEdit(self.excelBasicGroup)
        self.sheetEntry.setObjectName(u"sheetEntry")
        self.sheetEntry.setMaximumSize(QSize(16777215, 16777215))
        self.sheetEntry.setFont(font11)
        self.sheetEntry.setFocusPolicy(Qt.ClickFocus)
        self.sheetEntry.setCursorMoveStyle(Qt.VisualMoveStyle)
        self.sheetEntry.setClearButtonEnabled(True)

        self.horizontalLayout_7.addWidget(self.sheetEntry)


        self.gridLayout.addWidget(self.excelBasicGroup, 2, 1, 1, 1, Qt.AlignBottom)


        self.verticalLayout_2.addWidget(self.basicSettingsFrame)

        self.runFrame = QFrame(self.mainBodyContainer)
        self.runFrame.setObjectName(u"runFrame")
        sizePolicy9 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy9.setHorizontalStretch(0)
        sizePolicy9.setVerticalStretch(1)
        sizePolicy9.setHeightForWidth(self.runFrame.sizePolicy().hasHeightForWidth())
        self.runFrame.setSizePolicy(sizePolicy9)
        self.runFrame.setFrameShape(QFrame.NoFrame)
        self.runFrame.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_8 = QHBoxLayout(self.runFrame)
        ...
        self.runBtn = QPushButton(self.runFrame)
        self.runBtn.setObjectName(u"runBtn")
        self.runBtn.setMinimumSize(QSize(180, 42))
        font12 = QFont()
        ...
        self.runBtn.setFont(font12)
        self.runBtn.setStyleSheet(u"")
        icon11 = QIcon()
        icon11.addFile(u":/icons/icons/play.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.runBtn.setIcon(icon11)
        self.runBtn.setIconSize(QSize(24, 24))

        self.horizontalLayout_8.addWidget(self.runBtn, 0, Qt.AlignHCenter|Qt.AlignVCenter)
        ...
        self.verticalLayout_2.addWidget(self.runFrame)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.semiclonRadioBtn.setText(QCoreApplication.translate("MainWindow", u"semicolon", None))
        self.pipelineRadioBtn.setText(QCoreApplication.translate("MainWindow", u"pipeline", None))
        self.tebRadioBtn.setText(QCoreApplication.translate("MainWindow", u"tab", None))
        self.generalBasicGroup.setTitle(QCoreApplication.translate("MainWindow", u"General", None))
        self.outFilenameLabel.setText(QCoreApplication.translate("MainWindow", u"Output filename:", None))
        self.outFilenameEntry.setInputMask("")
        self.outFilenameEntry.setText("")
        self.outFilenameEntry.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Write your output filename", None))
        self.skipEmptyRowRadioBtn.setText(QCoreApplication.translate("MainWindow", u"Skip righe vuote", None))
        self.trimAllColumnsRadioBtn.setText(QCoreApplication.translate("MainWindow", u"Trim tutte le colonne", None))
        self.basicSettingsBtn.setText(QCoreApplication.translate("MainWindow", u"Opzioni base", None))
        self.excelBasicGroup.setTitle(QCoreApplication.translate("MainWindow", u"Excel file", None))
        self.sheetnameLabel.setText(QCoreApplication.translate("MainWindow", u"SheetName:", None))
